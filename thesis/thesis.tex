...
even though primary question  not fully answered, massive bottlenecks identified
...
system needs to sustain loads orders of magnitude higher than 25k
varying user distributions per region
dynamodb, CLUSTERS
improvement to the models so that weighs can be added to the scalability meteres according to preferences, so that they are not that sensitive
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
