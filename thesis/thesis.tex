...
\subsubsection{Real-Time Insights}
etsy, logster, graphite etc.

syncling clocks on machines using /etc/ntpd (polled from amazon servers)

[TODO insert image from our dashborad]

our system stuff + kernel tuning (so tcp shit you were plotting)
