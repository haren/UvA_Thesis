...
None so far? Not proving to be a bottleneck.
...
\section{Used Benchmarking Scenario}\label{Used Benchmarking Scenario}
...
c3.8xlarge instance, 32 CORES, 60GB, 2x320 GB SSD Storage
