...
The problem that I study in this research concerns application stack decomposition of the System Under Test \ref{The System Under Test}. It can be generalized to scalability of systems with similar characteristics - utilizing real-time, user-generated data, broadcast globally using the WebSocket protocol \ref{Websocket Protocol}.
