...
how they build their models, sample image etc.

The models are described in detail in the Scalability Measurements chapter \ref{Scalability Measurements}.

More related work is described in the following Background chapter \ref{Background}.
