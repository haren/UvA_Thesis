...
Furthermore, to have a scientific discussion about scalability, quantifiable models and metrics are necessary. The models I decided to use were introduced by Pattabhiraman et al. \cite{Models} and are described in details in a dedicated chapter \ref{Scalability Measurements}.
