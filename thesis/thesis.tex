...
Amazon introduces another limitation - no more than 5 read replicas per master. That made our setup slighlty asymmetrical - Irish WebSocket servers connect direcly to master instances, and Sydney's MySQL read replica replicates from Singapore's replica, and California's from Oregon (chaining up to 3 replicas is allowed).

[TODO all depicted on a diagram]
...
[TODO] INSERT DIAGRAM: Route53 -> Elb -> Nginx -> Api Server instance -> Redis MYSQL
